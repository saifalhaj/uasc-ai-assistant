    ...
    >
      <div className="bg-surf-1 border border-border-hi rounded-lg p-6 max-w-[460px] w-[calc(100%-40px)] shadow-[0_24px_60px_rgba(0,0,0,0.6)]">
        ...
        <p className="text-text-mid text-[13px] m-0 mb-4">
          The document and its embeddings will be deleted from the index. Existing chat answers
          that cite it will retain the citation as a tombstone.
        </p>
        ...
        <div className="flex gap-2 justify-end">
          ...
          >
            {isDeleting ? 'Removing…' : 'Remove from corpus'}
          </button>
        </div>
      </div>
    </div>
